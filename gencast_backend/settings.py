"""
Django settings for gencast_backend project.
...
ROOT_URLCONF = 'gencast_backend.urls'
...
WSGI_APPLICATION = 'gencast_backend.wsgi.application'
...
# Media files (Audio uploads/generations)
MEDIA_URL = '/media/'
